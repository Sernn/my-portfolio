...
export const heroIcons = [
  createElement(InstagramLineIcon),
  createElement(FacebookCircleLineIcon),
  createElement(DribbbleLineIcon),
  createElement(YoutubeLineIcon),
  createElement(GithubLineIcon),
]
...
export const aboutData = [
  {
    title: 'Github Repos',
    amount: 348,
    icon: createElement(GithubFillIcon),
  },
  {
    title: 'Successful Projects',
    amount: 227,
    icon: createElement(Projector2LineIcon),
  },
  {
    title: 'Satisfied clients',
    amount: 176,
    icon: createElement(GroupLineIcon),
  },
  {
    title: 'Awards and Recognition',
    amount: 107,
    icon: createElement(AwardFillIcon),
  },
]
...
export const downloadIcon = createElement(DownloadLineIcon)
export const arrowLeftIcon = createElement(ArrowLeftSFillIcon)

export const aboutText =
  " Hi, I'm Sern, a web developer & designer. I blend the technical  skills of web development with the creative aspects of web design. I code in HTML, CSS, JavaScript, React, NextJS... to build functional and responsive websites, while also using design tools like Photoshop and Figma to create visually appealing and user-friendly  interfaces. My role allows me to ensure that websites not only work well but also look great and provide an excellent user experience."
// End of About Me
...
export const starIcons = [createElement(StarFillIcon), createElement(StarHalfLineIcon)]
export const arrowIcons = [createElement(ArrowLeftSLineIcon), createElement(ArrowRightSLineIcon)]
...
export const checkIcon = createElement(CheckLineIcon)
...
export const questionArrow = createElement(ArrowDropDownLineIcon)

// Navbar
import CopyrightLineIcon from 'remixicon-react/CopyrightLineIcon'

export const copyRightIcon = createElement(CopyrightLineIcon)
...
export const navbarData = [
  {
    id: 'home',
    name: 'Home',
    icon: createElement(Home5LineIcon),
  },
  {
    id: 'about',
    name: 'About',
    icon: createElement(UserLineIcon),
  },
  {
    id: 'experience',
    name: 'MyRoad',
    icon: createElement(HistoryLineIcon),
  },
  {
    id: 'skills',
    name: 'Skills',
    icon: createElement(BriefcaseLineIcon),
  },
  {
    id: 'reviews',
    name: 'Reviews',
    icon: createElement(UserStarLineIcon),
  },
  {
    id: 'projects',
    name: 'Projects',
    icon: createElement(ProjectorLineIcon),
  },
  {
    id: 'pricing',
    name: 'Pricing',
    icon: createElement(PriceTag3LineIcon),
  },
  {
    id: 'contact',
    name: 'Contact',
    icon: createElement(ContactsBook2LineIcon),
  },
  {
    id: 'questions',
    name: 'Questions',
    icon: createElement(QuestionAnswerLineIcon),
  },
]
...
export const sunIcon = createElement(SunFoggyFillIcon)
export const moonIcon = createElement(MoonFoggyFillIcon)
