        ...
        {experienceData.map((data, i) => (
          <div
            ...
            className={`w-[600px] px-12  relative -left-[300px ${
              i % 2 === 0 ? '-left-[300px] xl:-left-[300px] lg:-left-0' : 'left-[300px] xl:left-[300px] lg:left-0'
            }]`}
            // className={`w-[600px] px-12  relative -left-[300px ${
          ...
          >
            ...
            >
              ...
              <span
                className={`absolute top-17.5 text-red-300 -translate-y1/2 ${
            ...
            <div
              className={`w-14 absolute top-20  border border-gray-500 rounded-full aspect-square grid place-items-center text-red-400 font-light -translate-y-1/2 z-10 bg-white ${
                i % 2 === 0 ? 'left-full -translate-x-1/2 left-1/2' : 'right-full translate-x-1/2 right-1/2'
              }`}
            >
